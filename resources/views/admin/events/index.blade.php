@extends('template.master',['title'=>'Evenements'])

@section('content')

  <main class="px-10 pt-10 pb-6">
    <h1 class="text-xl font-extrabold text-gray-700 mb-10">Evènements (<span class="text-red-500">{{$totals->count()}}</span>)</h1>
            ...
            <tbody>
              @foreach($posts as $post)
                ...
                <tr class="text-sm text-gray-600">
                  ...
                  <td>
                    <a href="{{route('admin.shows.evenements',$post->user)}}" class="text-xs bg-green-500 px-2 py-1 rounded-sm font-light text-white">Voir évènement.s</a>
                  </td>
                </tr>
