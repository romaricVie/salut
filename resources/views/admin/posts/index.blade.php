@extends('template.master',['title'=>'Publications'])

@section('content')

  <main class="px-10 pt-10 pb-6">
    <h1 class="text-xl font-extrabold text-gray-700 mb-10">Publications (<span class="text-red-500">{{$totals->count()}}</span>)</h1>
    ...
    <section class="bg-white p-4 rounded-md">
            ...
            <tbody>
              @foreach($posts as $post)
                ...
                <tr class="text-sm text-gray-600">
                  ...
                  <td>
                    <a href="{{route('admin.shows.posts',$post->user)}}" class="text-xs bg-green-500 px-2 py-1 rounded-sm font-light text-white">Voir publication.s</a>
                  </td>
                </tr>
      ...
      @else
        ...
        <div class="alert alert-primary alert-dismissible fade show" role="alert">
          <strong>Aucun post disponible pour l'instant!</strong>
