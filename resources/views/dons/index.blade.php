<x-app-layout>
      ...
      <article class="col-span-1 flex items-center justify-center mt-10 md:mt-0">
        ...
        >
          ...
          >
            ...
            >
              @csrf
                <h1 class="text-center text-gray-800 font-bold mb-6 text-lg md:text-xl">Don en nature</h1>
  ...
  <footer class="py-2 px-3 md:pr-0 lg:pl-20">
    <div class="flex flex-col md:flex-row items-center justify-center text-sm md:justify-start">
      ...
      <p class="md:ml-3"><img src="{{asset('/images/logo-texte.svg')}}" alt="logo affranchie" class="w-auto h-6 mr-2 inline"> &copy; 2021 - Tous droits réservés</p>
    </div>
  </footer>
